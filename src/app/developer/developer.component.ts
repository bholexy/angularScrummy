...
export class DeveloperComponent implements OnInit {
  ...
  usersVar: any;
  	...
  	constructor(private dragulaService: DragulaService, private httpClient: HttpClient, private data: DataService, private modalService: NgbModal, private router: Router, private route: ActivatedRoute)
  	 {
